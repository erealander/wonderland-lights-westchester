      ...
      <div className="container mx-auto max-w-6xl">
        <div className="text-center mb-8">
          <h2 className="text-5xl font-bold text-white mb-6">
            #1 Holiday Light Installation Westchester County
          </h2>
          <h3 className="text-3xl text-primary mb-8">
            Give Your Family The Best Holiday Season Ever
          </h3>
          
          <p className="text-lg text-white leading-relaxed mb-8 max-w-4xl mx-auto">
            This holiday season, use the professional services of Wonderland Holiday Lights and give your family the best holiday season ever. We provide a high-quality, safe, and affordable holiday light installation in Westchester County and Fairfield County. Our all-inclusive service includes free custom design, a free quote, installation, removal, and storage. We are here to take all the stress away and give you a holiday season to remember. Our lights will brighten up your home, your neighborhood, and your family&apos;s faces. Have an abundance of joy and magic this holiday season with Wonderland Holiday Lights. Once you have experienced our services, you&apos;ll never need anyone else.
          </p>
